...
class MustBeUpdateAuthToSetModelError extends Error {
    constructor() {
        super('Must be Update Authority to set the Constraint Model.');
        this.code = 0x74;
        this.name = 'MustBeUpdateAuthToSetModel';
        if (typeof Error.captureStackTrace === 'function') {
            Error.captureStackTrace(this, MustBeUpdateAuthToSetModelError);
        }
    }
}
exports.MustBeUpdateAuthToSetModelError = MustBeUpdateAuthToSetModelError;
createErrorFromCodeLookup.set(0x74, () => new MustBeUpdateAuthToSetModelError());
createErrorFromNameLookup.set('MustBeUpdateAuthToSetModel', () => new MustBeUpdateAuthToSetModelError());
class MissingEscrowConstraintModelError extends Error {
    constructor() {
        super('Missing EscrowConstraintModel.');
        this.code = 0x75;
        this.name = 'MissingEscrowConstraintModel';
        if (typeof Error.captureStackTrace === 'function') {
            Error.captureStackTrace(this, MissingEscrowConstraintModelError);
        }
    }
}
exports.MissingEscrowConstraintModelError = MissingEscrowConstraintModelError;
createErrorFromCodeLookup.set(0x75, () => new MissingEscrowConstraintModelError());
createErrorFromNameLookup.set('MissingEscrowConstraintModel', () => new MissingEscrowConstraintModelError());
class InvalidEscrowConstraintModelError extends Error {
    constructor() {
        super('Invalid EscrowConstraintModel.');
        this.code = 0x76;
        this.name = 'InvalidEscrowConstraintModel';
        if (typeof Error.captureStackTrace === 'function') {
            Error.captureStackTrace(this, InvalidEscrowConstraintModelError);
        }
    }
}
exports.InvalidEscrowConstraintModelError = InvalidEscrowConstraintModelError;
createErrorFromCodeLookup.set(0x76, () => new InvalidEscrowConstraintModelError());
createErrorFromNameLookup.set('InvalidEscrowConstraintModel', () => new InvalidEscrowConstraintModelError());
class EscrowConstraintViolationError extends Error {
    constructor() {
        super('Escrow Constraint Violation');
        this.code = 0x77;
        this.name = 'EscrowConstraintViolation';
        if (typeof Error.captureStackTrace === 'function') {
            Error.captureStackTrace(this, EscrowConstraintViolationError);
        }
    }
}
exports.EscrowConstraintViolationError = EscrowConstraintViolationError;
createErrorFromCodeLookup.set(0x77, () => new EscrowConstraintViolationError());
createErrorFromNameLookup.set('EscrowConstraintViolation', () => new EscrowConstraintViolationError());
class InvalidEscrowConstraintIndexError extends Error {
    constructor() {
        super('Invalid Escrow Constraint Index');
        this.code = 0x78;
        this.name = 'InvalidEscrowConstraintIndex';
        if (typeof Error.captureStackTrace === 'function') {
            Error.captureStackTrace(this, InvalidEscrowConstraintIndexError);
        }
    }
}
exports.InvalidEscrowConstraintIndexError = InvalidEscrowConstraintIndexError;
createErrorFromCodeLookup.set(0x78, () => new InvalidEscrowConstraintIndexError());
createErrorFromNameLookup.set('InvalidEscrowConstraintIndex', () => new InvalidEscrowConstraintIndexError());
