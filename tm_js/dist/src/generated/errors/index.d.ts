...
export declare class MustBeUpdateAuthToSetModelError extends Error {
    readonly code: number;
    readonly name: string;
    constructor();
}
export declare class MissingEscrowConstraintModelError extends Error {
    readonly code: number;
    readonly name: string;
    constructor();
}
export declare class InvalidEscrowConstraintModelError extends Error {
    readonly code: number;
    readonly name: string;
    constructor();
}
export declare class EscrowConstraintViolationError extends Error {
    readonly code: number;
    readonly name: string;
    constructor();
}
export declare class InvalidEscrowConstraintIndexError extends Error {
    readonly code: number;
    readonly name: string;
    constructor();
}
