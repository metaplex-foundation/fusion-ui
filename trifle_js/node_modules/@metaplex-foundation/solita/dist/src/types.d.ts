...
export declare type IdlInstructionAccount = {
    name: string;
    isMut: boolean;
    isSigner: boolean;
    desc?: string;
...
export declare type IdlType = BeetTypeMapKey | 'publicKey' | IdlTypeDefined | IdlTypeOption | IdlTypeVec | IdlTypeArray | IdlTypeEnum | IdlTypeDataEnum | IdlTypeTuple | IdlTypeMap | IdlTypeSet;
...
export declare type IdlDataEnumVariant = IdlDataEnumVariantWithNamedFields | IdlDataEnumVariantWithUnnamedFields | IdlEnumVariant;
export declare type IdlDataEnumVariantWithNamedFields = {
    name: string;
    fields: IdlField[];
};
export declare type IdlDataEnumVariantWithUnnamedFields = {
    name: string;
    fields: IdlType[];
};
export declare type IdlTypeEnum = IdlTypeScalarEnum | IdlTypeDataEnum;
export declare type IdlTypeScalarEnum = {
    kind: 'enum';
    name?: string;
    variants: IdlEnumVariant[];
};
export declare type IdlTypeDataEnum = {
    kind: 'enum';
    name?: string;
    variants: IdlDataEnumVariant[];
};
export declare type IdlTypeTuple = {
    tuple: IdlType[];
};
export declare type IdlTypeMap = IdlTypeHashMap | IdlTypeBTreeMap;
export declare type IdlTypeHashMap = {
    hashMap: [IdlType, IdlType];
};
export declare type IdlTypeBTreeMap = {
    bTreeMap: [IdlType, IdlType];
};
export declare type IdlTypeSet = IdlTypeHashSet | IdlTypeBTreeSet;
export declare type IdlTypeHashSet = {
    hashSet: IdlType;
};
export declare type IdlTypeBTreeSet = {
    bTreeSet: IdlType;
};
export declare type IdlFieldsType = {
    kind: 'struct' | 'enum';
    fields: IdlField[];
};
export declare type IdlDefinedTypeDefinition = {
    name: string;
    type: IdlFieldsType | IdlTypeEnum | IdlTypeDataEnum;
};
export declare type IdlInstructionArg = {
    name: string;
    type: IdlType;
};
...
export declare type IdlAccountType = {
    kind: 'struct' | 'enum';
    fields: IdlField[];
};
...
export declare type IdlOrigin = 'shank' | 'anchor';
export declare type ShankIdl = Idl & {
    instructions: ShankIdlInstruction[];
    metadata: ShankMetadata;
};
export declare type ShankIdlInstruction = IdlInstruction & {
...
export declare type IdlInstructionAccountWithDesc = IdlInstructionAccount & {
    desc: string;
};
export declare type ShankMetadata = Idl['metadata'] & {
    origin: 'shank';
};
export declare type PrimitiveTypeKey = BeetTypeMapKey | BeetSolanaTypeMapKey;
export declare type PrimaryType = SupportedTypeDefinition & {
    beet: BeetExports | BeetSolanaExports;
};
export declare type PrimaryTypeMap = Record<PrimitiveTypeKey, PrimaryType>;
export declare type ProcessedSerde = {
    name: string;
    sourcePack: SerdePackage;
    type: string;
    inner?: ProcessedSerde;
};
export declare type TypeMappedSerdeField = {
    name: string;
    type: string;
};
export declare type ResolveFieldType = (typeName: string) => IdlAccountType | IdlTypeEnum | null;
...
export declare type PrimitiveType = Exclude<NumbersTypeMapKey, typeof BIGNUM>;
export declare const BIGNUM: readonly ["u64", "u128", "u256", "u512", "i64", "i128", "i256", "i512"];
export declare type Bignum = typeof BIGNUM[number];
